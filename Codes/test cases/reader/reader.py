...
#         u = data['Parameters']
         ...
         t13 = np.append(t13,t[7])
         t14 = np.append(t14,t[8])
         t15 = np.append(t15,t[9])
         t16 = np.append(t16,t[10])
         t17 = np.append(t17,t[11])
#         v= c['VMStress']
#         vm=max(v)
...
plt.plot(x,t13,label='t[13]')
plt.plot(x,t14,label='t[14]')
plt.plot(x,t15,label='t[15]')
plt.plot(x,t16,label='t[16]')
plt.plot(x,t17,label='t[17]')
plt.grid(True)
