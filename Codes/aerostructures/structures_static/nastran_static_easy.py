...
class NastranStatic(ExternalCode):
    ...
    output_file = 'nastran_static.out'


    def __init__(self, node_id, node_id_all, n_stress, tn, mn):
        ...
        self.input_filepath = 'nastran_static.inp'
        self.output_filepath = 'nastran_static.pnh'
